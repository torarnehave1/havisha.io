...
export default {
  ...
  appDescription: process.env.APPLICATION_DESCRIPTION || 'Default App Description',
  appSlogan: process.env.APPLICATION_SLOGAN || 'Default App Slogan',
  appTitle: process.env.APPLICATION_TITLE || 'Default App Title',
  appVersion: process.env.APPLICATION_VERSION || 'Default App Version',
